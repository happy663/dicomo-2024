	...
	\scalebox{0.7}{
		\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|c|c|} % Change 'l' to 'c' for center alignment
			\hline
			              ...
			              &                              &                              & \multicolumn{2}{c|}{BLEビーコン} &                              & \makecell{磁気                                                                                                } & BLEビーコン & \multicolumn{2}{c|}{正解初期}    & \multicolumn{2}{c|}{補正}                                               \\ \cline{4-5} \cline{7-7} \cline{8-8}\cline{9-10}\cline{11-12}
			              & 加速度                          & 角速度                          & 基地局位置                        & 電波強度                         & フロアマップ                                                                                                        & FP      & FP                           & 座標                           & 方向 & 座標                           & 方向 \\ \hline
